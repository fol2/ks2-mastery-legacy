...
function Dashboard({ onOpenSubject, profile, onEditProfile }) {
  const greeting = (() => {
      ...
      <section style={{
        ...
        <div style={{
          ...
          <svg viewBox="0 0 200 200" width="220" height="220" style={{
            position: 'absolute', right: -60, top: -60, opacity: 0.55,
          }}>
            <circle cx="100" cy="100" r="90" fill="none" stroke={TOKENS.lineSoft} strokeWidth="28" />
            <circle cx="100" cy="100" r="60" fill="none" stroke={TOKENS.line} strokeWidth="16" />
          </svg>
            ...
            <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
              ...
              {profile && (
                <button onClick={onEditProfile} title="Edit profile" style={{
                  marginLeft: 6, display: 'flex', alignItems: 'center', gap: 10,
