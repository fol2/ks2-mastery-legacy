...
- `docs/*`
  - Audit, architecture, refactor plan, migration map, repository notes, state-integrity notes, a dedicated spelling-service contract note, a direct spelling parity audit, and spelling content-model notes.
- `tests/*`
