...
- browser boot still uses the local content repository by default; the API content repository exists as the backend contract path, not as the default shell boot path
